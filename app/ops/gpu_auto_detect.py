...
def detect_gpu():
    ...
    if gpu_detected:
        ...
        if gpu_vram_mb >= 20000:
            ...
            os.environ["EXECUTION_THREAD_COUNT"] = "6"
            print(f"[GPU-DETECT] High VRAM ({gpu_vram_mb}MB) -> hyperswap_1a_256, 6 threads")
        ...
        os.environ["ORT_CUDA_GRAPH"] = "0"
        os.environ["ORT_CUDA_USE_UNIFIED_MEMORY"] = "0"
    else:
